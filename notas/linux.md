...
1991 - Linus Torvalds - Começou a desenvolver um kernel como hobby, inspirado pelo sistema operacional educacional MINIX (que iria virar proprietário).
...
GNU + Linux = O Sistema Operacional Completo

Quando você pensa em servidores, cloud, containers, IoT, smartphones (Android) e supercomputadores, está pensando em Linux - mesmo que não saiba disso. É sério! Mais de 90% da infraestrutura da internet roda Linux. Quase 100% das empresas Fortune 500 usam Linux nos seus ambientes. E tem mais: 100% dos supercomputadores do TOP500 rodam Linux!
